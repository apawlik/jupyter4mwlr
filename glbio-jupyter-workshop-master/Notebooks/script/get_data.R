...
countdata <- read.csv("https://ndownloader.figshare.com/files/3560183", header=TRUE, row.names=1)
coldata <- read.csv("https://ndownloader.figshare.com/files/3560180", header=TRUE, row.names=1)
